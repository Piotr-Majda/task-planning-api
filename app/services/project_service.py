...
class ProjectService:
    def __init__(self, repo: ProjectRepository, user_repo: UserRepository, project_assignment_policy: ProjectAssignmentPolicy) -> None:
    ...
    def create(self, project_create: ProjectCreate) -> Project:
        if project_create.owner_id is not None:
            self._project_assignment_policy.validate_owner_exists(project_create.owner_id)
    ...
    def update(self, id: int, project_update: ProjectUpdate) -> Project:
        if project_update.owner_id is not None:
            self._project_assignment_policy.validate_owner_exists(project_update.owner_id)
        project = self.get(id)
    ...
    def add_member(self, project_id: int, user_id: int) -> ProjectMember:
        self._project_assignment_policy.validate_project_exists(project_id)
        self._project_assignment_policy.validate_member_exists(user_id)
    ...
    def remove_membership(self, project_id: int, user_id: int):
        self._project_assignment_policy.validate_project_exists(project_id)
        self._project_assignment_policy.validate_user_has_membership(project_id=project_id, user_id=user_id)
